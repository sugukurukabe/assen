...
- **モノレポへの統合**：設計書§2.3で「モノレポ維持（`sugukuru-aios/apps/compliance`）」と決定済みだが、実際にaiosリポジトリへ統合する作業は未実施（現状はスタンドアロンのディレクトリ）
...
| M2 T2P | T2P全書類、派遣3点、期限イベント、freee連携、2026-10-01要領改正の追従実戦 | 未着手 |
