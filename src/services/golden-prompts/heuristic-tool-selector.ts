...
const TOOL_KEYWORDS: Record<string, string[]> = {
  "job_order_analyze": ["求人メール", "解析", "原文"],
  "job_order_confirm": ["帳簿", "確定", "求人票"],
  "dispatch_assignment_confirm": ["派遣就業", "派遣元管理台帳", "台帳に記帳"],
  "compliance_evaluate": ["コンプライアンス", "適合性", "評価", "判定"],
  "document_preview": ["プレビュー", "下書き確認", "仕上がり"],
  "document_generate_draft": ["ドラフト", "労働条件通知書", "書類を作成", "生成して"],
  "document_request_approval": ["承認依頼", "承認を依頼", "レビュー依頼"],
  "document_approve": ["承認する", "承認して", "承認します"],
  "document_attach_executed_copy": ["署名済み", "押印済み", "添付"],
  "document_record_delivery": ["交付", "渡した", "送付記録"],
  "document_supersede": ["差し替え", "訂正版", "再発行"],
  "job_seeker_confirm": ["求職者情報", "求職者台帳"],
  "job_order_referral_confirm": ["紹介行", "紹介欄"],
  "placement_confirm": ["採否", "採用可否"],
  "placement_record_rejection_reason": ["不採用理由", "理由を記録"],
};
