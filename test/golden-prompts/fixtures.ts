...
export const goldenPromptFixtures: GoldenPromptFixture[] = [
  ...
  { id: "direct-analyze", category: "direct", prompt: "この求人メールを解析してください。", expectedToolNames: ["job_order_analyze"] },
  { id: "direct-confirm", category: "direct", prompt: "この求人情報を帳簿に確定してください。", expectedToolNames: ["job_order_confirm"] },
  {
    id: "direct-dispatch-assignment-confirm",
    category: "direct",
    prompt: "この派遣就業を派遣元管理台帳に記帳してください。",
    expectedToolNames: ["dispatch_assignment_confirm"],
  },
  { id: "direct-evaluate", category: "direct", prompt: "この案件のコンプライアンス評価をしてください。", expectedToolNames: ["compliance_evaluate"] },
  { id: "direct-preview", category: "direct", prompt: "この書類のプレビューを見せてください。", expectedToolNames: ["document_preview"] },
  {
    id: "direct-generate-draft",
    category: "direct",
    prompt: "労働条件通知書のドラフトを生成してください。",
    expectedToolNames: ["document_generate_draft"],
  },
  {
    id: "direct-request-approval",
    category: "direct",
    prompt: "この書類の承認依頼を出してください。",
    expectedToolNames: ["document_request_approval"],
  },
  { id: "direct-approve", category: "direct", prompt: "この書類を承認してください。", expectedToolNames: ["document_approve"] },
  {
    id: "direct-attach-executed-copy",
    category: "direct",
    prompt: "署名済みの書類を添付してください。",
    expectedToolNames: ["document_attach_executed_copy"],
  },
  {
    id: "direct-record-delivery",
    category: "direct",
    prompt: "この書類を交付した記録を残してください。",
    expectedToolNames: ["document_record_delivery"],
  },
  { id: "direct-supersede", category: "direct", prompt: "この書類を差し替えてください。", expectedToolNames: ["document_supersede"] },
  {
    id: "direct-job-seeker-confirm",
    category: "direct",
    prompt: "この求職者情報を求職者台帳へ登録してください。",
    expectedToolNames: ["job_seeker_confirm"],
  },
  {
    id: "direct-job-order-referral-confirm",
    category: "direct",
    prompt: "この求人と求職者の紹介行を登録してください。",
    expectedToolNames: ["job_order_referral_confirm"],
  },
  {
    id: "direct-placement-confirm",
    category: "direct",
    prompt: "この案件の採否を登録してください。",
    expectedToolNames: ["placement_confirm"],
  },
  {
    id: "direct-placement-record-rejection-reason",
    category: "direct",
    prompt: "不採用理由を記録してください。",
    expectedToolNames: ["placement_record_rejection_reason"],
  },
  ...
  // --- 間接指示 / Indirect instructions / Instruksi tidak langsung ---
  {
    ...
    expectedToolNames: ["job_order_analyze"],
  },
  {
    id: "indirect-confirm",
    category: "indirect",
    prompt: "この求人票の内容を帳簿に載せてもらってもいいですか？",
    expectedToolNames: ["job_order_confirm"],
  },
  {
  ...
  },
  {
    ...
    expectedToolNames: ["compliance_evaluate"],
  },
  {
    id: "indirect-preview",
    category: "indirect",
    prompt: "本番で送る前に、下書き確認だけしておきたいのですが。",
    expectedToolNames: ["document_preview"],
  },
  {
  ...
  },
  {
    ...
    expectedToolNames: ["document_approve"],
  },
  {
  ...
  },
  {
    ...
    expectedToolNames: ["document_supersede"],
  },
  {
